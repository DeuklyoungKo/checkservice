                ...
                <Card className="border-2 shadow-2xl shadow-primary/5 rounded-3xl overflow-hidden bg-card">
                    ...
                    <CardFooter className="bg-muted/30 p-4 border-t">
                        <p className="text-xs text-center w-full text-muted-foreground leading-relaxed">
                            계속 진행함으로써 Trend Scouter의 <Link href="#" className="underline hover:text-primary">서비스 약관</Link> 및 <Link href="#" className="underline hover:text-primary">개인정보 보호정책</Link>에 동의하게 됩니다.
                        </p>
                    </CardFooter>
                </Card>
